...
export function IssueSidePanel({
  ...
  return (
    <div className="pointer-events-none absolute bottom-5 right-5 top-28 z-[710] hidden w-[360px] md:block">
      <GlassPanel className="pointer-events-auto max-h-full overflow-y-auto p-5">
